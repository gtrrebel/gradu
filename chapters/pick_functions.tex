...
\begin{proof}
	Take any sequence $z_{1}, z_{2}, \ldots$ converging to $z_{0}$: we claim the Newton series with nodes $z_{1}, z_{2}, \ldots$ gives the (by analyticity necessarily unique) extension for $\varphi$ to $\D(z_{0}, \Im(z_{0})) \setminus U$.

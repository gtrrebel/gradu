...
Note that this result far from clear: pointwise limits of analytic functions need not in general be analytic. We will not prove this result yet, but it strongly suggests that the class of Pick functions is very rigid in some sense.

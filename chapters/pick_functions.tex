...
\begin{proof}[Proof of theorem \ref{open_pick_nevanlinna}]
	...
	Now the Zorn's lemma works if we change the condition a bit: we look at all the open supersets of $U$, $V$'s such that there exists extension of $\varphi$ to $V$ in such a way that all the Pick matrices of the extension are positive in $V$.
\end{proof}

...
\textbf{Warning!} The dual and predual terminology above is somewhat non-standard. Often dual cones are subsets of the dual space (with definition as one would expect). Preduals would be defined similarly.

...
Note that there are only three conditions in this theorem. In the monotone case we could take $H$ to be projection, but with the convex case this is not (a priori) possible anymore.

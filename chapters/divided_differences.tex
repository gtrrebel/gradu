...
As mentioned in the introduction, $k$-tone functions correspond to the functions with non-negative $k$'th derivative\footnote{The terminology is not very established, and such functions are also occasionally called $k$-monotone or $k$-convex.}. What should this mean?
...
The previous observation could have also be used to prove the identity \ref{peano_identity} itself. TODO green's function

...
\end{lause}
\begin{proof}
	t.f.i.f. \ref{peano_theorem} and the mean value theorem for integrals.
\end{proof}
...
\begin{prop}
	Let $f : \D(z_{\infty}, \rho) \to \C$ be analytic and $z_{0}, z_{1}, \ldots \in \D(z_{\infty}, \rho)$ sequence converging to $z_{\infty}$. Then \ref{newton_series} holds for any $z \in \D(z_{\infty}, \rho)$.
\end{prop}
\begin{proof}

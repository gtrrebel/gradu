...
\begin{itemize}
	...
	\item Divided differences are local in the sense that if $f$ and $g$ agree on $\{x, y\}$, divided differences agree; this observation readily implies the continuity claim.
\end{itemize}
...
One can also interpret such identities to be strictly formal: Cauchy's integral formula can be thought as a bijection between rational functions with simple poles and the span of $\delta$-measures. Many such signed measures look simpler as rational functions.

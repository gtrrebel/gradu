...
\begin{proof}
	...
	\begin{align*}
		x^2 = \int_{0}^{\infty} \chi_{(t, \infty)}(x) dt.
	\end{align*}
\end{proof}
...
\end{prop}
\begin{proof}
	Adding linear is means just translating domain and codomain, which is not going to help: $x^2 + \alpha x = (x + \frac{\alpha}{2})^2 - \frac{\alpha^2}{4}$.
\end{proof}
...
Now when $n$ gets larger we have more and more space to worry about, so we should start worrying about more and more Taylor coefficients.

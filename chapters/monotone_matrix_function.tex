...
\begin{lem}
	...
	\begin{enumerate}[(i)]
		...
		\begin{align*}
			[x_{1}, x_{1}, \ldots, x_{1}, x_{2}, \ldots, x_{2}, \ldots, x_{n}, \ldots, x_{n}]_{f} \geq 0
		\end{align*}
...
\begin{proof}
	$(i) \Rightarrow (ii)$ is clear. \textcolor{red}{One cannot use the same idea naively! What to do?}
\end{proof}

We have hence the following.

\begin{lause}
	Let $n \geq 1$ and $f \in C^{1}(a, b)$. Then $f \in P_{n}(a, b)$, if and only if $f h$ is $(2 n - 1)$-tone for every polynomial of degree at most $(2 n - 2)$, $h$, non-negative on real line. 
\end{lause}

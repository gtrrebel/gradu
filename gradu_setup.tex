...
\newtheorem{esimx}[equation]{Example}

\newenvironment{esim}
  {\pushQED{\qed}\renewcommand{\qedsymbol}{$\triangle$}\esimx}
  {\popQED\endesimx}

\newtheorem{huomx}[equation]{Remark}

\newenvironment{huom}
  {\pushQED{\qed}\renewcommand{\qedsymbol}{$\triangle$}\huomx}
  {\popQED\endhuomx}
